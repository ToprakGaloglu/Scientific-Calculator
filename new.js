...
function add() {
    ...
    const inputValue = parseFloat(prompt("Enter a number to add:")) || 0;
    display.value = currentValue + inputValue;
}

function subtract() {
    const display = document.getElementById("result");
    const currentValue = parseFloat(display.value) || 0;
    const inputValue = parseFloat(prompt("Enter a number to subtract:")) || 0;
    display.value = currentValue - inputValue;
}
...
function multiply() {
    const display = document.getElementById("result");
    const currentValue = parseFloat(display.value) || 0;
    const inputValue = parseFloat(prompt("Enter a number to multiply:")) || 0;
    display.value = currentValue * inputValue;
}
...
function divide() {
    const display = document.getElementById("result");
    const currentValue = parseFloat(display.value) || 0;
    const inputValue = parseFloat(prompt("Enter a number to divide:")) || 0;
    display.value = currentValue / inputValue;
}
